...
This project is a simple ERP-style database I built for a synthetic small online retail store. The goal was to connect sales, inventory, and financial data into one system and then use SQL to analyze it.
...
add suppliers and purchasing flow to make it closer to a full ERP system.
